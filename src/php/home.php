    ...
    <body data-bs-theme="dark" class="my-4">
            ...
            <div class="row">
                ...
                <form method="post" class="col-sm-6 col d-flex flex-column align-items-center justify-content-center gap-3">
                    ...
                    <div class="container d-flex gap-2">
                        <button class="btn btn-outline-danger w-100 rounded-2 text-light" type="reset">Alanı Temizle</button>
                ...
                <div class="col-sm-6 col d-flex align-items-center justify-content-center">
                    ...
                    <lottie-player
                        src="https://assets7.lottiefiles.com/packages/lf20_x1gjdldd.json"
                        mode="bounce"
                        ...
                        <?php
                            ...
                            if ($result) {
                                while ($row = mysqli_fetch_assoc($result)) {
                                    ...
                                    <td>' . $department . '</td>
                                    <td>' . $date . '</td>                                
                                    <td><button class="btn btn-outline-primary w-100"><a class="link" href="./update.php?updateid=' . $id . '">Güncelle</a> </button></td>
                                    <td><button class="btn btn-outline-danger w-100" ><a class="link" href="./delete.php?deleteid=' . $id . '">Sil</a> </button></td>
                                    </tr>';
                                }
                            } ?>
                </tbody>
        ...
        <div class="container my-4">
            <a class="link" href="logout.php">
                <button class="btn btn-outline-primary w-100 rounded-2 text-light" type="button">Çıkış Yap</button>
            </a>
        </div>
